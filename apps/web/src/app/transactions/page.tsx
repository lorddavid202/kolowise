...
export default function TransactionsPage() {
  ...
  const filteredTransactions = useMemo(() => {
    ...
    return transactions.filter((txn) => {
      ...
      const matchesDirection =
        ...
        directionFilter === "all" || txn.direction === directionFilter;

      const matchesAccount =

        accountFilter === "all" || txn.account_id === accountFilter;
  ...
  }, [transactions, search, directionFilter, accountFilter, categoryFilter]);
  ...
  async function handleCsvUpload(e: React.FormEvent) {
    ...
    try {
      ...
      setUploadMessage(`CSV uploaded successfully. Inserted ${data.inserted_count} transaction(s).`);
